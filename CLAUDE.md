...
| ↳ Faster backfill | **Envio HyperSync / HyperRPC** | — | Envio has **first-class Arc Testnet support**: HyperSync at `https://arc-testnet.hypersync.xyz`, plus HyperRPC. Point Ponder's transport at HyperRPC to escape the 10k-range limit and get orders-of-magnitude faster historical sync. Best of both: Ponder's DX, Envio's ingestion. |
...
- `https://envio.dev/chains/arc-testnet` — HyperSync at `https://arc-testnet.hypersync.xyz`
