/**
 * A throwaway Postgres database per suite, built from the committed migration.
 *
 ...
 * whether a `jsonb` payload round-trips a session whole, or whether `onConflictDoUpdate`
 * writes what its author meant — and closing it is
