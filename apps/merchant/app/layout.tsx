...
export const metadata: Metadata = {
  title: "Plazo — merchant",
  description: "Every settlement, what it cost, where it went, and how to reconcile it.",
};
...
export default function RootLayout({children}: {children: React.ReactNode}) {
  return (
    <html lang="en">
      <head>
        {/*
          Self-hosted in production. Loaded from Google here because the dashboard is a
